...
class BreedsControllerTest < ActionController::TestCase
  ...
  test "should create breed" do
    assert_difference('Breed.count') do
      post :create, breed: { lifespan: @breed.lifespan, name: @breed.name, pure: @breed.pure, shed: @breed.shed }
    end
  ...
  test "should update breed" do
    patch :update, id: @breed, breed: { lifespan: @breed.lifespan, name: @breed.name, pure: @breed.pure, shed: @breed.shed }
    assert_redirected_to breed_path(assigns(:breed))
  end
